...
TECHNO_IMG = "https://telegra.ph/file/edef1d69ff8f44dcce674.jpg"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="🤝HELP🤝",
                                                                       ...
                                                                       url="t.me/nafiz_145")],
                                                                                   [InlineKeyboardButton(text="ADD GROUP HELP BOT TO YOUR GROUP",
                                                                       url="t.me/{}?startgroup=true".format(bot.username)),
                                                                                   InlineKeyboardButton(text="Source Code",
                                                                       url="https://github.com/Nafiz14/GRANDROBOT")
                                                                                 ]]))

    else:
        update.effective_message.reply_text("JINDA HOON BHAI 😁😁")
